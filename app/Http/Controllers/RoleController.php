...
class RoleController extends Controller
{
    ...
    public function __construct()
   {
    ...
    public function store(Request $request)
    {
        ...
        $role->save();
        //Looping thru selected permission
        ...
        Flash()->success(" ROLE $role->name ADDED SUCCESSFULLY!! ");
    ...
    public function update(Request $request, $id)
    {
        ...
        foreach ($p_all as $p) {
            $role->revokePermissionTo($p); //Remove all permission associated with role
        }
    ...
    public function destroy($id)
    {
        ...
        if ($role->hasPermissionTo('Administer roles & permissions')){
            ...
            flash()->success("$role->name cant be deleted");
            return redirect()->route('roles.index');
        }
        $role->delete();
